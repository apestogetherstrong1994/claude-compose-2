...
The author is writing and has paused. Based on the document so far and their voice, write the next 1-3 sentences that naturally continue their thought.

DO NOT output any structural tags like [SUGGESTION]. Just output the continuation text directly as plain text. Write in the author's voice. Keep it to 1-3 sentences maximum. Make it feel like the natural next thing they would write.
${ctx}`;
